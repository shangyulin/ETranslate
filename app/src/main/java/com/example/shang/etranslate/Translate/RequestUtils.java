...
public class RequestUtils {
    ...
    private static final String appId = "20170430000045967";

    //申请成功后的证书token，实际使用时请修改成开发者自己的token
    private static final String token = "5E2TykJT8M5Z_P3IHRaK";
    ...
    public static void translate(final String q, final String from, final String to, final HttpCallBack callBack) {
        try{
            //用于md5加密
            ...
            String str = new String(md5String.getBytes(), "utf-8");
            final String sign = MD5Encoder.encode(str);
